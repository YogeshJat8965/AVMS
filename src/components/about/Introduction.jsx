          ...
          <div className="mb-12">
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 lg:p-16 border border-gray-100">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-center" style={{ color: '#023E60' }}>
                  A Legacy of Professional Excellence Since 1993
                </h2>
                <div className="w-20 h-1 mx-auto mb-8" style={{ backgroundColor: '#159645' }}></div>
